...
Real xrandom;
...
#if 0
     	iters += ks_congrad_field_u1( F_OFFSET(phi1), F_OFFSET(xxx1), mass1,
	    niter, nrestart, rsqmin, PRECISION, EVEN, &final_rsq, &fn_links_u1 );
     	iters += ks_congrad_field_u1( F_OFFSET(phi2), F_OFFSET(xxx2), mass2,
	    niter, nrestart, rsqmin, PRECISION, EVEN, &final_rsq, &fn_links_u1 );
#else
	...
	dslash_fn_field_u1( F_OFFSET(xxx1), F_OFFSET(xxx1), ODD, &fn_links_u1);
	dslash_fn_field_u1( F_OFFSET(xxx2), F_OFFSET(xxx2), ODD, &fn_links_u1);
