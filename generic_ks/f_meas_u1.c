...
BOMB THE COMPILE
	...
	/*scalar_mult_add_su3_vector( &(st->tempvec[0]), &(st->templongvec[0]),
      ...
      r_haldane_odd =  haldane_o.real*(8.0/(double)my_volume);
      i_haldane_odd =  haldane_o.imag*(8.0/(double)my_volume);
      r_haldane_even =  haldane_e.real*(8.0/(double)my_volume);
      i_haldane_even =  haldane_e.imag*(8.0/(double)my_volume);
