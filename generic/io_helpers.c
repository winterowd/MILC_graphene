...
void funnylat(void)  {
	...
	for(dir=XUP;dir<=TUP;dir++){
	    ...
	    sit->link[dir].e[0][0].real = 1.0;
	    /*sit->link[dir].e[0][0].real = dir + sit->x;
	    sit->link[dir].e[1][1].real = dir + sit->x;
	    sit->link[dir].e[2][2].real = dir + sit->x;
	    sit->link[dir].e[0][0].imag = dir + sit->x;
	    sit->link[dir].e[1][1].imag = dir + sit->x;
	    sit->link[dir].e[2][2].imag = dir + sit->x;*/
	}
    }
}
